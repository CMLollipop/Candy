                                      ...
                                      NSDictionary*responseObject))failure
{
    ...
    [[HttpClient share]doGet:@"http://apis.baidu.com/txapi/qiwen/qiwen"
                      params:mParam
                     success:^(NSDictionary *responseObject) {
                         ...
                         if (code.integerValue == 200) {
                             ...
                             [[ManageCoreData instance]insertMeinvList:[MeinvModel arrayWithModelObjectList:objectList] type:@2 successBlock:^(NSDictionary *result)
                              {
    ...
    [[HttpClient share]doGet:@"http://apis.baidu.com/txapi/mvtp/meinv"
                     ...
                     success:^(NSDictionary *responseObject) {
                         ...
                         if (code.integerValue == 200) {
                             ...
                             [[ManageCoreData instance]insertMeinvList:[MeinvModel arrayWithModelObjectList:objectList] type:@1 successBlock:^(NSDictionary *result)
                              {
                                  success(@{@"meinvList":objectList});
